...
add_action('init', function(){
    ...
    add_shortcode(
        'gmuw_gmuwellbeing_shortcode', //shortcode label (use as the shortcode on the site)
        'gmuw_gmuwellbeing_shortcode' //callback function
    );
...
function gmuw_gmuwellbeing_shortcode(){
